      ...
      <HomeComponentWrap style={{ padding: '15vh 7vw' }}>
        <TextWrap>
          ...
          <Text $fontSize="23px" $fontWeight="200" $color="#E5E5E5" style={{ marginTop: '2em' }}>
            ...
            global stage. Our new mission and brand identity is based on the foundation to contribute towards a happier
            and healthier humanity.
          </Text>
        </TextWrap>
      </HomeComponentWrap>
        ...
        <ContentBox style={{ padding: '0 7vw 0 0' }}>
          ...
          <ContentWrap>
            ...
            <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'start', gap: '0.5em' }}>
              <Text $fontSize="20px" $fontWeight="300" $color="#D5D5D5" $align="start" style={{ width: 'fit-content' }}>
                Ari:
              </Text>
              <Text $fontSize="20px" $fontWeight="300" $color="#D5D5D5" $align="start">
