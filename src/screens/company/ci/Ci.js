            ...
            <ContentBox style={{padding: '0 7vw 0 0', gap: '1.5rem'}}>
              ...
              <ContentWrap style={{flexDirection: 'row', padding: '0', justifyContent: 'space-between'}}>
                <Text
                  ...
                  <span style={{zIndex: '-1', fontSize: window.innerWidth > 1280 ? '20px' : '12px'}}>AI download</span>
                  <Image
                    src={arrow}
                    alt="arrow"
                    style={{
                ...
                <Text
                  ...
                  <span style={{zIndex: '-1', fontSize: window.innerWidth > 1280 ? '20px' : '12px'}}>PNG download</span>
                  <Image
                    src={arrow}
                    alt="arrow"
            ...
            <ContentBox style={{padding: '5rem 5vw '}}>
              ...
              <ContentWrap style={{flexDirection: 'column', padding: '0', justifyContent: 'start', alignItems: 'end'}}>
                <Text
                  ...
                  onClick={() => downloadCi('ai')}>
                  <span style={{zIndex: '-1'}}>{t('ci.dl.ai')}</span>
                ...
                <Text
                  ...
                  onClick={() => downloadCi('png')}>
                  <span style={{zIndex: '-1'}}>{t('ci.dl.png')}</span>
                  <Image src={arrow} alt="arrow" style={{width: '10px', zIndex: '-1'}} />
                </Text>
              </ContentWrap>
            </ContentBox>
