    ...
    <HomeComponentWrap id="irpr_detailpage">
      ...
      <Mobile>
        <ComponentWrap style={{ justifyContent: 'center', alignItems: 'start' }}>
          ...
          >
            <Image
              style={{ transform: 'rotate(180deg)', zIndex: '-1', height: '2rem' }}
              src={icon_circlearrow_dark}
              alt="go back"
            />
            <Text style={{ width: 'fit-content', margin: '1em 0', padding: '0', zIndex: '-1', fontSize: '18px' }}>
              Back
            </Text>
          </span>
        </ComponentWrap>
        <ComponentWrap id="printableid" style={{ justifyContent: 'center', alignItems: 'start' }}>
          ...
          <Text style={{ width: '100%', margin: '1rem 0', padding: '0', textAlign: 'start', fontSize: '21px' }}>
            {currentItem?.title}
          </Text>
          <HR style={{ margin: '1rem 0', width: '40px', height: '1px' }} />
          <Text
            style={{
              width: '100%',
              margin: '1em 0',
        ...
        >
          <Button onClick={() => clickPrint()}>
            ...
            <Image style={{ zIndex: '-1', height: '2rem' }} src={arrow} alt="print" />
          </Button>
        </div>
      </Mobile>
    </HomeComponentWrap>
