      ...
      <HomeComponentWrap>
        <TextWrap style={{ margin: '0' }}>
          ...
          <Text $fontSize="23px" $fontWeight="200" $color="#E5E5E5" style={{ margin: '2em 0' }}>
            ...
            drugs. To accelerate the development of drugs with multiple mechanisms of action, we’ve unveiled ARIS – our
            cutting-edge AI platform designed for dependable in-silico predictions and analyses.
          </Text>
        </TextWrap>
      </HomeComponentWrap>
      <HomeComponentWrap>
        <TextWrap style={{ width: 'fit-content' }}>
          ...
          <Text $fontSize="23px" $fontWeight="200" $color="#ffffff" style={{ marginTop: '2em', width: '70vw' }}>
            ...
            ADMET processes. While crucial for single-mechanism drug exploration, polypharmacological discovery demands
            a nuanced approach. Polypharmacology requires a deep understanding of interactions among drugs, proteins,
            cells, and diseases, alongside the ability to predict and identify novel biological relationships. To
            address this complexity, ARIBIO’s Platform Research Center has developed ARIS: a proprietary AI platform
            optimized for predicting these multifaceted biological interrelationships, thus advancing our drug discovery
            initiatives.
          </Text>
        </TextWrap>
        ...
        <TextWrap style={{ width: 'fit-content', marginTop: '10em' }}>
          ...
          <Text $fontSize="23px" $fontWeight="100" $color="#C9C9C9" style={{ marginTop: '2em', width: '70vw' }}>
            ...
            cohesive <span style={{ color: '#ffffff', fontWeight: '300' }}>Bridge</span>, seamlessly linking the KG and
            ARIS{' '}
            <span style={{ color: '#ffffff', fontWeight: '300' }}>
      ...
      <HomeComponentWrap>
        <TextWrap style={{ marginBottom: '10em' }}>
          ...
          <Text $fontSize="23px" $fontWeight="100" $color="#C9C9C9" style={{ marginTop: '2em' }}>
            ...
            Entity Recognition (NER) and Relation Extraction (RE). The execution flow and interplay of these methods are
            illustrated below:
          </Text>
        </TextWrap>
        <ComponentWrap style={{ padding: '0' }}>
          <ComponentWrap style={{ flexDirection: 'row', paddingTop: '8em', height: '100%' }}>
            <ComponentWrap
